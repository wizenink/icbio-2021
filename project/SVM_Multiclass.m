function [trainACC,testACC] = SVM(dataset,PredictorNames,ResponseName,args,c)
arguments
    dataset(1,:) char;
...
for n=1:3
    for i=1:k
        trIdx = CV.training(i);
        t = templateSVM(args{:}); %rbf, probar otras
        MdL{i}=fitcecoc(INPUTS,OUTPUTS,'Learners',t,'Coding',c);
    end
