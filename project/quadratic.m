function [trainACC,testACC] = quadratic(dataset)
disp('Empezando EL PROCESO DE ENTRENAMIENTO para el conjunto de datos de Cancer (con CV.partition)');
disp('%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%');
...
for i = 1:3
    for i = 1:k
        trIdx = CV.training(i); %Extraccion de los indices del conjunto de entrenamiento
...
savefile = 'ResultadosQuadraticCancer';
